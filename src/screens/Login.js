...
GoogleSignin.configure({
  webClientId:
    "657776415952-0upum9rpsfnslfmfuldlnr6r208e92fu.apps.googleusercontent.com", // must match the "web" client ID in Firebase
  offlineAccess: false,
});
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://mocktestapi.rizee.in/api/v1/auth/google-auth",
        payload
      );
      ...
      <View contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={styles.header}>
          ...
          <Text style={[styles.tagline, { color: "#ffffff" }]}>
            <Text
              style={{ fontWeight: "bold", fontSize: 25, color: "#e614e1" }}
            >
              Unlock
            </Text>{" "}
            the Gateway to{" "}
          ...
          <Text
            style={[
              styles.tagline,
              { color: "#e614e1", marginLeft: 120, marginTop: 5 },
            ]}
          >
            Better Learning !{" "}
          </Text>
          ...
          <View style={{ padding: 20 }}>
            ...
            <View
              style={[
                ...
                { borderColor: errors.password ? theme.red : "#e614e1" },
              ]}
            >
              <TextInput
                style={[
            ...
            <TouchableOpacity onPress={!loading && handleLogin}>
              <LinearGradient
                colors={["#e614e1", "#8b51fe"]}
                style={[styles.loginButton]}
              >
                <Text
                  style={[styles.loginButtonText, { color: theme.textColor1 }]}
                >
                  {loading ? (
                    <View
                      style={{
            ...
            <View style={styles.footer}>
              <View style={{ flexDirection: "row" }}>
                ...
                >
                  <Text
                    style={[styles.signUpText, { color: theme.accentText }]}
                  >
                    Sign Up
                  </Text>
                </TouchableOpacity>
